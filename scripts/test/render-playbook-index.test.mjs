...
test("renderPlaybookIndex embeds discover data without replacing the template shell", async () => {
  ...
  try {
    ...
    assert.match(html, /class="discovery-layout"/);
    assert.match(html, /class="discovery-side-nav"/);
    assert.match(html, /data-discovery-nav="opportunities"/);
    assert.match(html, /data-discovery-nav="evidence"/);
    assert.match(html, /data-discovery-nav="cases"/);
    assert.match(html, /data-discovery-nav="scripts"/);
    assert.match(html, /data-discovery-nav="tracker"/);
    assert.match(html, /data-discovery-nav="pipeline"/);
    assert.match(html, /id="discovery-opportunities"/);
    assert.match(html, /id="discovery-evidence"/);
    assert.match(html, /id="discovery-cases"/);
    assert.match(html, /id="discovery-scripts"/);
    assert.match(html, /id="discovery-tracker"/);
